...
\begin{itemize}
  ...
  \item Identificar mediante profiling los cuellos de botella en los casos donde
        la escalabilidad sea reducida, usando \texttt{perf stat} y el nuevo
        sistema de muestreo de Python~3.15 para medir el coste de sincronización
...
muestreo de Python~3.15 los costes de sincronización y el balance de carga. El
