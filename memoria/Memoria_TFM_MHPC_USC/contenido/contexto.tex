...
\hline
0 & puro      & Transformación OMP4Py sobre el runtime Python. \\
1 & híbrido   & Transformación AST + hilos Python; sin compilación. \\
...
En los modos~0 y~1, las directivas se transforman mediante el árbol sintáctico
abstracto (AST) del módulo \texttt{ast} de Python. El modo~0 actúa como línea
base funcional sobre el runtime Python de OMP4Py, sin generación de código
Cython. El modo~1 usa la ruta híbrida con hilos Python reales mediante la API de
\texttt{threading}, de modo que en Python~\emph{free-threaded} puede aprovechar
múltiples núcleos. Los modos~2 y~3 compilan los kernels a C mediante
Cython~\cite{Cython2011}. La
...
\begin{itemize}
  ...
  \item \textbf{CG} (\emph{Conjugate Gradient}): estimación del menor
        autovalor de una matriz esparsa irregular mediante gradiente conjugado.
