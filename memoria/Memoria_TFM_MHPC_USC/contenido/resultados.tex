...
bucles críticos; con modo~3, esos bucles pasan a ejecutarse como código nativo
efectivo.
...
son los candidatos naturales a escalar; CG, IS y MG están más condicionados por
sincronización, granularidad o accesos irregulares.
...
reduce los tiempos entre uno y varios órdenes de magnitud frente al modo~2.
...
general: CG, IS y MG siguen limitados por sincronización, granularidad y
patrones de memoria.

El Capítulo~\ref{chap:profiling} utiliza \texttt{perf stat} para relacionar
los speedups observados con ocupación real de CPU, IPC y eventos de memoria. El
