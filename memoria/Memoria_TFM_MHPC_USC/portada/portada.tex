\begin{titlepage}
  ...
  \hspace*{128pt}
  \textcolor{udcgray}{{\fontencoding{T1}\fontfamily{phv}\selectfont Departamento de Electrónica e Computación}}\\[-2pt]
  \hspace*{145pt}
  ...
  \begin{flushright}
    ...
    \end{tabular}}
  \end{flushright}
  \rightline{Santiago de Compostela, junio de 2026.}
\end{titlepage}
