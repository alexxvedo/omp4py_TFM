...
\begin{description}
  ...
  \item[Modo de ejecución] En OMP4Py, configuración que determina qué partes
        del código se compilan: modo~0 (runtime puro de OMP4Py en Python),
        modo~1 (híbrido, runtime nativo cuando está disponible; kernels sin
        compilar), modo~2 (kernels compilados con Cython) y modo~3 (kernels
        compilados con tipado Cython explícito).
  ...
  \item[Profiler de muestreo] Herramienta que observa periódicamente las pilas
        de llamadas de los hilos de un proceso. En este trabajo se usa para
        estimar qué fracción del tiempo paralelo cae en cómputo, espera o
        inicialización.

  \item[Profiler de trazado] Herramienta determinista que registra llamadas a
        funciones y permite obtener recuentos exactos. En este trabajo se usa
        para contar regiones paralelas, hilos creados y entradas en barrera.
